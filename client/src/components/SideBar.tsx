...
function SideBar(){
    ...
    const navBarItems : { name: NavItem; path: string; icon: React.ReactNode } [] = [
                    ...
                    {navBarItems.map((n, i) => {
                        ...
                        return (
                            ...
                            onClick={() => {
                                ...
                                <span className="
                                    size-6 md:size-5 lg:size-6
                                    mx-3.5 md:mx-0 md:mr-2
                                ">{n.icon}</span>

                                <span className="hidden md:inline">{n.name}</span>
